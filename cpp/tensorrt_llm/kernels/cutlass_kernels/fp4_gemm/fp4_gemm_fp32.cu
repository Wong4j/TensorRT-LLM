...
template class CutlassFp4GemmRunner<float, fp4_gemm::FP4GemmType::W4A4_NVFP4_NVFP4>;
template class CutlassFp4GemmRunner<float, fp4_gemm::FP4GemmType::W4A8_MXFP4_MXFP8>;
