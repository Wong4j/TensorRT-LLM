...
# 检查是否是 2 的幂次
print(f"\n=== Power of 2 Analysis ===")
print(f"262144 = 2^{262144.bit_length() - 1}")
print(f"k = {k} = 2^{k.bit_length() - 1}")
print(f"k_compressed = {k_compressed} = 2^{k_compressed.bit_length() - 1}")
...
for factor in possible_factors:
    if 262144 % factor == 0:
        ...
        print(f"262144 = {factor} × {quotient} = 2^{factor.bit_length()-1} × {quotient}")
