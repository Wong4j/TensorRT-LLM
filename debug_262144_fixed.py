...
print(f"262144 / {k_compressed} = {target_value / k_compressed}")
print(f"262144 / {k} = {target_value / k}")

# 检查是否是 2 的幂次
print(f"\n=== Power of 2 Analysis ===")
exp = target_value.bit_length() - 1
...
print(f"262144 / m = {target_value / m}")
print(f"262144 / n = {target_value / n}")
print(f"262144 / k = {target_value / k}")
print(f"262144 / k_compressed = {target_value / k_compressed}")
...
for const in constants:
    if target_value % const == 0:
        print(f"262144 = {const} × {target_value // const}")
